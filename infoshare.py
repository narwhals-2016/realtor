...
# missing_a = [k for k, v in all_matches.items() if v == 'MISSING']
missing = ['Kensington-Ocean Parkway', 'Crotona Park East', 'Morningside Heights', 'Gramercy', 'Upper East Side-Carnegie Hill', 'East Harlem South', 'Stuyvesant Town-Cooper Village', 'Williamsbridge-Olinville', 'Central Harlem North-Polo Grounds', 'Georgetown-Marine Park-Bergen Beach-Mill Basi', 'Lincoln Square', 'Springfield Gardens North', 'Midtown-Midtown South', 'North Riverdale-Fieldston-Riverdale', 'Bronxdale', 'Van Nest-Morris Park-Westchester Square', 'DUMBO-Vinegar Hill-Downtown Brooklyn-Boerum H', 'Allerton-Pelham Gardens', 'East Concourse-Concourse Village', 'Ocean Parkway South', 'Pelham Parkway', 'Clinton Hill', 'Madison brookl', 'Queensboro Hill queens', 'Bensonhurst East', 'New Springville-Bloomfield-Travis', 'New Brighton-Silver Lake', 'West Village', 'Grymes Hill-Clifton-Fox Hills', 'Eastchester-Edenwald-Baychester', 'Central Harlem South', 'New Dorp-Midland Beach', 'SoHo-TriBeCa-Civic Center-Little Italy', 'Old Town-Dongan Hills-South Beach', "Annadale-Huguenot-Prince's Bay-Eltingville", 'Belmont bronx', 'West Farms-Bronx River', 'Van Cortlandt Village', "Mariner's Harbor-Arlington-Port Ivory-Granite", 'Carroll Gardens-Columbia Street-Red Hook', 'Spuyten Duyvil-Kingsbridge', 'Breezy Point-Belle Harbor-Rockaway Park-Broad', 'West Brighton', 'Jamaica Estates-Holliswood', 'Westchester-Unionport', 'Schuylerville-Throgs Neck-Edgewater Park', 'Turtle Bay-East Midtown', 'Claremont-Bathgate', 'Arden Heights', 'Rugby-Remsen Village', 'Mount Hope', 'Todt Hill-Emerson Hill-Heartland Village-Ligh', 'Erasmus', 'Prospect Lefferts Gardens-Wingate', 'Westerleigh', 'East Harlem North', 'Bedford Park-Fordham North', 'West Concourse', 'Sheepshead Bay-Gerritsen Beach-Manhattan Beac', 'Mott Haven-Port Morris', 'Rikers Island', 'Rossville-Woodrow', 'Ocean Hill', 'Bensonhurst West', 'Co-Op City', 'North Side-South Side', 'Grasmere-Arrochar-Ft. Wadsworth', 'Brooklyn Heights-Cobble Hill', 'Briarwood-Jamaica Hills', 'Oakwood-Oakwood Beach', 'Fordham South', 'Kingsbridge Heights', "hell's kitchen", 'Bedford brooklyn', 'Springfield Gardens South-Brookville']
...
# nb_in_zip(missing, fuzzy_dict), 22 matches
more_matches = {'Jamaica Estates-Holliswood': '11423', 'Kensington-Ocean Parkway': '11218', 'Midtown-Midtown South': '10019', 'Sheepshead Bay-Gerritsen Beach-Manhattan Beac': '11235', 'Brooklyn Heights-Cobble Hill': '11201', 'Briarwood-Jamaica Hills': '11435', 'Mott Haven-Port Morris': '10454', 'Westchester-Unionport': '10461', 'Van Nest-Morris Park-Westchester Square': '10462', "Annadale-Huguenot-Prince's Bay-Eltingville": '10312', 'Williamsbridge-Olinville': '10467', 'Rossville-Woodrow': '10309', 'Stuyvesant Town-Cooper Village': '10009', 'New Brighton-Silver Lake': '10301', 'West Farms-Bronx River': '10460', 'Grymes Hill-Clifton-Fox Hills': '10301', 'North Riverdale-Fieldston-Riverdale': '10471', 'Eastchester-Edenwald-Baychester': '10475', 'Carroll Gardens-Columbia Street-Red Hook': '11231', 'New Dorp-Midland Beach': '10306', 'Schuylerville-Throgs Neck-Edgewater Park': '10465', 'Bedford Park-Fordham North': '10458'}

# combined all_matches and more_matches, 135 matches total
latest_matches = {
	'Allerton-Pelham Gardens': 'MISSING',
	...
	'Bedford brooklyn': 'MISSING',
	'Bellerose': '11426',
	'Belmont bronx': 'MISSING',
	'Bensonhurst East': 'MISSING',
	'Bensonhurst West': 'MISSING',
	'Borough Park': '11219',
	'Breezy Point-Belle Harbor-Rockaway Park-Broad': 'MISSING',
	...
	'Central Harlem North-Polo Grounds': 'MISSING',
	'Central Harlem South': 'MISSING',
	'Charleston-Richmond Valley-Tottenville': '10307',
	'Chinatown': '10013',
	'Claremont-Bathgate': 'MISSING',
	'Clinton Hill': 'MISSING',
	'Co-Op City': 'MISSING',
	'College Point': '11356',
	'Corona': '11368',
	'Crotona Park East': 'MISSING',
	'Crown Heights North': '11225',
	'Crown Heights South': '11225',
	'Cypress Hills-City Line': '11208',
	'DUMBO-Vinegar Hill-Downtown Brooklyn-Boerum H': 'MISSING',
	'Douglas Manor-Douglaston-Little Neck': '11362',
	'Dyker Heights': '11228',
	'East Concourse-Concourse Village': 'MISSING',
	'East Elmhurst': '11369',
	'East Flatbush-Farragut': '11203',
	'East Flushing': '11354',
	'East Harlem North': 'MISSING',
	'East Harlem South': 'MISSING',
	'East New York': '11207',
	'East New York (Pennsylvania Ave)': '11207',
	'East Tremont': '10457',
	'East Village': '10009',
	...
	'Flatlands': '11234',
	'Flushing': '11354',
	'Fordham South': 'MISSING',
	'Forest Hills': '11375',
	'Fort Greene': '11205',
	'Fresh Meadows-Utopia': '11365',
	'Ft. Totten-Bay Terrace-Clearview': '11360',
	'Georgetown-Marine Park-Bergen Beach-Mill Basi': 'MISSING',
	'Glen Oaks-Floral Park-New Hyde Park': '11040',
	'Glendale': '11385',
	'Gramercy': 'MISSING',
	'Grasmere-Arrochar-Ft. Wadsworth': 'MISSING',
	'Gravesend': '11223',
	'Great Kills': '10308',
	'Greenpoint': '11222',
	...
	'Kew Gardens': '11415',
	'Kew Gardens Hills': '11415',
	'Kingsbridge Heights': 'MISSING',
	'Laurelton': '11413',
	'Lenox Hill-Roosevelt Island': '10044',
	'Lincoln Square': 'MISSING',
	'Lindenwood-Howard Beach': '11414',
	'Longwood': '10455',
	'Lower East Side': '10002',
	'Madison brookl': 'MISSING',
	'Manhattanville': '10027',
	'Marble Hill-Inwood': '10034',
	"Mariner's Harbor-Arlington-Port Ivory-Granite": 'MISSING',
	'Maspeth': '11378',
	'Melrose South-Mott Haven North': '10451',
	'Middle Village': '11379',
	'Midtown-Midtown South': '10019',
	'Midwood': '11230',
	'Morningside Heights': 'MISSING',
	'Morrisania-Melrose': '10456',
	'Mott Haven-Port Morris': '10454',
	'Mount Hope': 'MISSING',
	'Murray Hill': '10016',
	...
	'New Springville-Bloomfield-Travis': 'MISSING',
	'North Corona': '11368',
	'North Riverdale-Fieldston-Riverdale': '10471',
	'North Side-South Side': 'MISSING',
	'Norwood': '10467',
	'Oakland Gardens': '11364',
	'Oakwood-Oakwood Beach': 'MISSING',
	'Ocean Hill': 'MISSING',
	'Ocean Parkway South': 'MISSING',
	'Old Astoria': '11102',
	'Old Town-Dongan Hills-South Beach': 'MISSING',
	'Ozone Park': '11417',
	'Parkchester': '10462',
	'Pelham Bay-Country Club-City Island': '10464',
	'Pelham Parkway': 'MISSING',
	'Pomonok-Flushing Heights-Hillcrest': '11354',
	'Port Richmond': '10302',
	'Prospect Heights': '11238',
	'Prospect Lefferts Gardens-Wingate': 'MISSING',
	'Queens Village': '11428',
	'Queensboro Hill queens': 'MISSING',
	'Queensbridge-Ravenswood-Long Island City': '11106',
	'Rego Park': '11374',
	'Richmond Hill': '11418',
	'Ridgewood': '11385',
	...
	'Rugby-Remsen Village': 'MISSING',
	'Schuylerville-Throgs Neck-Edgewater Park': '10465',
	'Seagate-Coney Island': '11224',
	'Sheepshead Bay-Gerritsen Beach-Manhattan Beac': '11235',
	'SoHo-TriBeCa-Civic Center-Little Italy': 'MISSING',
	'Soundview-Bruckner': '10472',
	'Soundview-Castle Hill-Clason Point-Harding Pa': '10472',
	'South Jamaica': '11433',
	'South Ozone Park': '11436',
	'Springfield Gardens North': 'MISSING',
	'Springfield Gardens South-Brookville': 'MISSING',
	'Spuyten Duyvil-Kingsbridge': 'MISSING',
	'St. Albans': '11412',
	'Stapleton-Rosebank': '10305',
	'Starrett City': '11239',
	'Steinway': '11105',
	...
	'Sunset Park East': '11220',
	'Sunset Park West': '11220',
	'Todt Hill-Emerson Hill-Heartland Village-Ligh': 'MISSING',
	'Turtle Bay-East Midtown': 'MISSING',
	'University Heights-Morris Heights': '10453',
	'Upper East Side-Carnegie Hill': 'MISSING',
	'Upper West Side': '10024',
	'Van Cortlandt Village': 'MISSING',
	'Van Nest-Morris Park-Westchester Square': '10462',
	'Washington Heights North': '10033',
	'Washington Heights South': '10033',
	'West Brighton': 'MISSING',
	'West Concourse': 'MISSING',
	'West Farms-Bronx River': '10460',
	'West New Brighton-New Brighton-St. George': '10310',
	'West Village': 'MISSING',
